class Gantry < Formula
  ...
  if OS.mac? && Hardware::CPU.arm?
    url "https://github.com/trygantry/gantry-distribution/releases/download/v#{version}/gantry-macos-aarch64"
    sha256 "5e866d956920ed8824103d74075e3489971ebb4f5c6d87aaa4102f59b9cf0466"
  elsif OS.mac?
    url "https://github.com/trygantry/gantry-distribution/releases/download/v#{version}/gantry-macos-x86_64"
    sha256 "53cd709ad2135a853264f6e905fd794acd52d41323470751a3f9756749ffe57f"
  else
    url "https://github.com/trygantry/gantry-distribution/releases/download/v#{version}/gantry-linux-x86_64"
